...
Кодын тайлбар ---
| Үйлдэл | type | Юу хийдэг вэ |
|--------|------|---------------|
| append | `1 ` | `s`string-г current string ард нь нэмнэ |
| delete | `2 ` | төгсгөлөөс `k` тэмдэгт устгана |
| print  | `3 ` | `k`-дахь үсгийг хэвлэнэ |
| undo   | `4 ` | хамгийн сүүлийн `append` эсвэл `delete`-г буцаана | top болон pop ащиглан     
